        ...
        <div className="w-full flex flex-col md:flex-row md:items-center md:justify-between gap-12">
          ...
          <div className="space-y-4 flex flex-col items-center md:items-start md:w-1/2">
            ...
            <div className="flex space-x-4 mt-4 justify-center md:justify-start">
              <a href="https://www.facebook.com/share/1AgM6jCLZF/?mibextid=wwXIfr" target="_blank" rel="noopener noreferrer" className="text-white/80 hover:text-primary transition-colors">
                <span className="sr-only">Facebook</span>
                <svg className="h-6 w-6" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
                  <path fillRule="evenodd" d="M22 12c0-5.523-4.477-10-10-10S2 6.477 2 12c0 4.991 3.657 9.128 8.438 9.878v-6.987h-2.54V12h2.54V9.797c0-2.506 1.492-3.89 3.777-3.89 1.094 0 2.238.195 2.238.195v2.46h-1.26c-1.243 0-1.63.771-1.63 1.562V12h2.773l-.443 2.89h-2.33v6.988C18.343 21.128 22 16.991 22 12z" clipRule="evenodd" />
                </svg>
              </a>
              <a href="https://www.instagram.com/udara.store_?igsh=MTE5eXhwajEzanhlaw%3D%3D&utm_source=qr" target="_blank" rel="noopener noreferrer" className="text-white/80 hover:text-primary transition-colors">
          ...
          <div className="w-full md:w-1/2 flex flex-col md:flex-row justify-end gap-12 md:gap-16">
            ...
            <div className="flex-1 flex flex-col items-center md:items-end">
              ...
              <ul className="space-y-2">
                ...
                <li>
                  <Link to="/furniture" className="text-white/80 hover:text-primary transition-colors">
                    Furniture
                  </Link>
                </li>
                <li>
